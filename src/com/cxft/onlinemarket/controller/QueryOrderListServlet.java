...
public class QueryOrderListServlet extends BaseServlet {
	...
	protected void doRequest(HttpServletRequest request,
		...
		String toolBar = page.getToolBar("QueryOrderListServlet"); 
		request.setAttribute("toolBar", toolBar); 
		request.getRequestDispatcher(
				"/admin/includes/column/orderManage/query_order.jsp")
