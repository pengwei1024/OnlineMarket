...
<body>
	<header id="header">
		...
		<div class="topbar">
			...
			%>
			<span class="left">欢迎光临传习在线书城:&nbsp;&nbsp;
			<a href="ShowUserInfoServlet"><%=user%></a>
			&nbsp;&nbsp;<a
			...
			<ul class="right">
				...
				<li><a href="${pageContext.request.contextPath }/OrderListServlet">我的订单</a></li>
				<li><a href="${pageContext.request.contextPath }/ShowUserInfoServlet">客戶服务</a></li>
				<li><a href="">网站导航</a></li>
			</ul>
		</div>
		<div class="logo">
			...
			<div class="header-search">
				...
				<form method="get" action="searchbox">
					...
					<input type="submit"  value="搜索"  id="searchbox_btn" />
				</form>
				</div>
			...
			<div class="header-toolbar">
				...
				<div class="header-toolbar-t">
					...
					<span >去购物车结算 <span class="header-toolbar-shop-count">${contu==0?"":contu}</span>
					</span>
				</div>
			</div>
		</div>
		<div class="nav">
			<ul>
				...
				<li><a href="DisplayBookServlet?type=newbook">新书上架</a></li>
				<li><a href="DisplayBookServlet?type=salebook">特价书籍</a></li>
				<li><a href="DisplayBookServlet?type=sellingbook">畅销书籍</a></li>
				<li><a href="OrderListServlet">我的订单</a></li>
				<li><a href="ShowUserInfoServlet">用户中心</a></li>
			</ul>
		</div>
	</header>